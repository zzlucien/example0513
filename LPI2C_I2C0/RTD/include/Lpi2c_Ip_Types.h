...
#define LPI2C_IP_TYPES_AR_RELEASE_MINOR_VERSION       4
#define LPI2C_IP_TYPES_AR_RELEASE_REVISION_VERSION    0
#define LPI2C_IP_TYPES_SW_MAJOR_VERSION               1
...
typedef struct
{
    ...
    Lpi2c_Ip_MasterStateType * MasterState;           /**< Pointer to master state */
...
typedef struct
{
    ...
    uint8 CallbackParam;                              /**< Parameter for the slave callback function */
    Lpi2c_Ip_SlaveStateType * SlaveState;           /**< Pointer slave state */
