...
#define LPI2C_IP_SW_MAJOR_VERSION_C               1
...
static Dma_Ip_LogicChannelTransferListType Lpi2c_Ip_aDmaChannelTransferListReceive[I2C_DMA_CHANNEL_CONFIG_LIST_SIZE_MASTER];
static Dma_Ip_LogicChannelTransferListType Lpi2c_Ip_aDmaChannelTransferListSend[I2C_DMA_CHANNEL_CONFIG_LIST_SIZE_MASTER];

/* Structures for configuration the master DMA channel */
static Dma_Ip_LogicChannelTransferListType Lpi2c_Ip_aDmaSlaveChTransferListReceive[I2C_DMA_CHANNEL_CONFIG_LIST_SIZE_SLAVE];
static Dma_Ip_LogicChannelTransferListType Lpi2c_Ip_aDmaSlaveChTransferListSend[I2C_DMA_CHANNEL_CONFIG_LIST_SIZE_SLAVE];
 ...
 *
 *END**************************************************************************/
static void Lpi2c_Ip_MasterConfigureTxDmaChannel(uint8 Instance)
{
    LPI2C_Type *BaseAddr = Lpi2c_Ip_pxBase[Instance];
    const Lpi2c_Ip_MasterStateType *Master = Lpi2c_Ip_pxMasterState[Instance];
    ...
    Lpi2c_Ip_aDmaChannelTransferListSend[0u].Value = (uint32)(&(Master->DataBuffer[0]));
    Lpi2c_Ip_aDmaChannelTransferListSend[3u].Value = (uint32)(&(BaseAddr->MTDR));
    Lpi2c_Ip_aDmaChannelTransferListSend[7u].Value = Master->BufferSize;

    (void)Dma_Ip_SetLogicChannelTransferList(Master->DmaTxChannel, Lpi2c_Ip_aDmaChannelTransferListSend, I2C_DMA_CHANNEL_CONFIG_LIST_SIZE_MASTER);
    /* Start DMA channel */
 ...
 *
 *END**************************************************************************/
static void Lpi2c_Ip_MasterConfigureRxDmaChannel(uint8 Instance)
{
    LPI2C_Type *BaseAddr = Lpi2c_Ip_pxBase[Instance];
    const Lpi2c_Ip_MasterStateType *Master = Lpi2c_Ip_pxMasterState[Instance];
    ...
    Lpi2c_Ip_aDmaChannelTransferListReceive[0u].Value = (uint32) (&(BaseAddr->MRDR));
    Lpi2c_Ip_aDmaChannelTransferListReceive[3u].Value = (uint32)(&(Master->DataBuffer[0]));
    if(I2C_MAX_DATA_RECEIVE_BYTE_PER_CMD > Master->BufferSize)
    {
        Lpi2c_Ip_aDmaChannelTransferListReceive[7u].Value = Master->BufferSize;
    }
    else
    {
        Lpi2c_Ip_aDmaChannelTransferListReceive[7u].Value = I2C_MAX_DATA_RECEIVE_BYTE_PER_CMD - 1U;
    }
    (void)Dma_Ip_SetLogicChannelTransferList(Master->DmaRxChannel, Lpi2c_Ip_aDmaChannelTransferListReceive, I2C_DMA_CHANNEL_CONFIG_LIST_SIZE_MASTER);
    /* Start DMA channel */
    (void)Dma_Ip_SetLogicChannelCommand(Master->DmaRxChannel, DMA_IP_CH_SET_HARDWARE_REQUEST);
}
#endif
 ...
 *
 *END**************************************************************************/
static void Lpi2c_Ip_MasterStartDmaTransfer(uint8 Instance)
{
    LPI2C_Type *BaseAddr = Lpi2c_Ip_pxBase[Instance];
 ...
 *
 *END**************************************************************************/
static void Lpi2c_Ip_SlaveStartDmaTransfer(uint8 Instance)
{
    LPI2C_Type *BaseAddr = Lpi2c_Ip_pxBase[Instance];
    ...
    {
        /* Set source address and major loop transfer size */
        Lpi2c_Ip_aDmaSlaveChTransferListSend[0u].Value = (uint32)(&(Slave->DataBuffer[0]));
        Lpi2c_Ip_aDmaSlaveChTransferListSend[3u].Value = (uint32)(&(BaseAddr->STDR));
        Lpi2c_Ip_aDmaSlaveChTransferListSend[7u].Value = Slave->BufferSize;
        Lpi2c_Ip_aDmaSlaveChTransferListSend[8u].Value = Slave->BufferSize;

        (void)Dma_Ip_SetLogicChannelTransferList(Slave->DmaTxChannel, Lpi2c_Ip_aDmaSlaveChTransferListSend, I2C_DMA_CHANNEL_CONFIG_LIST_SIZE_SLAVE);
        /* Start DMA channel */
    ...
    {
        /* Set destination address and major loop transfer size */
        Lpi2c_Ip_aDmaSlaveChTransferListReceive[0u].Value = (uint32) (&(BaseAddr->SRDR));
        Lpi2c_Ip_aDmaSlaveChTransferListReceive[3u].Value = (uint32)(&(Slave->DataBuffer[0]));
        Lpi2c_Ip_aDmaSlaveChTransferListReceive[7u].Value = Slave->BufferSize;
        Lpi2c_Ip_aDmaSlaveChTransferListReceive[8u].Value = 0U;

        (void)Dma_Ip_SetLogicChannelTransferList(Slave->DmaRxChannel, Lpi2c_Ip_aDmaSlaveChTransferListReceive, I2C_DMA_CHANNEL_CONFIG_LIST_SIZE_SLAVE);
        /* Start DMA channel */
...
static void Lpi2c_Ip_SlaveCmdDmaTcdInit(void)
{
    ...
    Lpi2c_Ip_aDmaSlaveChTransferListSend[0u].Param = DMA_IP_CH_SET_SOURCE_ADDRESS;
    Lpi2c_Ip_aDmaSlaveChTransferListSend[1u].Param = DMA_IP_CH_SET_SOURCE_SIGNED_OFFSET;
    Lpi2c_Ip_aDmaSlaveChTransferListSend[2u].Param = DMA_IP_CH_SET_SOURCE_TRANSFER_SIZE;
    /* Destination configuration parameters */
    Lpi2c_Ip_aDmaSlaveChTransferListSend[3u].Param = DMA_IP_CH_SET_DESTINATION_ADDRESS;
    Lpi2c_Ip_aDmaSlaveChTransferListSend[4u].Param = DMA_IP_CH_SET_DESTINATION_SIGNED_OFFSET;
    Lpi2c_Ip_aDmaSlaveChTransferListSend[5u].Param = DMA_IP_CH_SET_DESTINATION_TRANSFER_SIZE;
    /* Minor/Major Loop parameters */
    Lpi2c_Ip_aDmaSlaveChTransferListSend[6u].Param = DMA_IP_CH_SET_MINORLOOP_SIZE;
    Lpi2c_Ip_aDmaSlaveChTransferListSend[7u].Param = DMA_IP_CH_SET_MAJORLOOP_COUNT;
    /* Adjustment added to source address at the beginning of TX buffer */
    Lpi2c_Ip_aDmaSlaveChTransferListSend[8u].Param = DMA_IP_CH_SET_SOURCE_SIGNED_LAST_ADDR_ADJ;

    /* Source  configuration values */
    Lpi2c_Ip_aDmaSlaveChTransferListSend[1u].Value = 1U;
    Lpi2c_Ip_aDmaSlaveChTransferListSend[2u].Value = DMA_IP_TRANSFER_SIZE_1_BYTE;
    /* Destination configuration values */
    Lpi2c_Ip_aDmaSlaveChTransferListSend[4u].Value = 0U;
    Lpi2c_Ip_aDmaSlaveChTransferListSend[5u].Value = DMA_IP_TRANSFER_SIZE_1_BYTE;
    /* Minor/Major Loop values */
    Lpi2c_Ip_aDmaSlaveChTransferListSend[6u].Value = 1U;

    /* Configure DMA channel for receive transfers*/
    /* Source  configuration parameters  */
    Lpi2c_Ip_aDmaSlaveChTransferListReceive[0u].Param = DMA_IP_CH_SET_SOURCE_ADDRESS;
    Lpi2c_Ip_aDmaSlaveChTransferListReceive[1u].Param = DMA_IP_CH_SET_SOURCE_SIGNED_OFFSET;
    Lpi2c_Ip_aDmaSlaveChTransferListReceive[2u].Param = DMA_IP_CH_SET_SOURCE_TRANSFER_SIZE;
    /* Destination configuration parameters  */
    Lpi2c_Ip_aDmaSlaveChTransferListReceive[3u].Param = DMA_IP_CH_SET_DESTINATION_ADDRESS;
    Lpi2c_Ip_aDmaSlaveChTransferListReceive[4u].Param = DMA_IP_CH_SET_DESTINATION_SIGNED_OFFSET;
    Lpi2c_Ip_aDmaSlaveChTransferListReceive[5u].Param = DMA_IP_CH_SET_DESTINATION_TRANSFER_SIZE;
    /* Minor/Major Loop parameters */
    Lpi2c_Ip_aDmaSlaveChTransferListReceive[6u].Param = DMA_IP_CH_SET_MINORLOOP_SIZE;
    Lpi2c_Ip_aDmaSlaveChTransferListReceive[7u].Param = DMA_IP_CH_SET_MAJORLOOP_COUNT;
    /* Adjustment added to source address at the beginning of TX buffer */
    Lpi2c_Ip_aDmaSlaveChTransferListReceive[8u].Param = DMA_IP_CH_SET_SOURCE_SIGNED_LAST_ADDR_ADJ;

    /* Source  configuration values */
    Lpi2c_Ip_aDmaSlaveChTransferListReceive[1u].Value = 0U;
    Lpi2c_Ip_aDmaSlaveChTransferListReceive[2u].Value = DMA_IP_TRANSFER_SIZE_1_BYTE;
    /* Destination configuration values */
    Lpi2c_Ip_aDmaSlaveChTransferListReceive[4u].Value = 1U;
    Lpi2c_Ip_aDmaSlaveChTransferListReceive[5u].Value = DMA_IP_TRANSFER_SIZE_1_BYTE;
    /* Minor/Major Loop values */
    Lpi2c_Ip_aDmaSlaveChTransferListReceive[6u].Value = 1U;
}
#endif /* STD_ON == LPI2C_IP_DMA_FEATURE_AVAILABLE */
...
static void Lpi2c_Ip_MasterCmdDmaTcdInit(void)
{
    /* Configure DMA channel for send transfers */
    /* Source  configuration parameters  */
    Lpi2c_Ip_aDmaChannelTransferListSend[0u].Param = DMA_IP_CH_SET_SOURCE_ADDRESS;
    Lpi2c_Ip_aDmaChannelTransferListSend[1u].Param = DMA_IP_CH_SET_SOURCE_SIGNED_OFFSET;
    Lpi2c_Ip_aDmaChannelTransferListSend[2u].Param = DMA_IP_CH_SET_SOURCE_TRANSFER_SIZE;
    /* Destination configuration parameters */
    Lpi2c_Ip_aDmaChannelTransferListSend[3u].Param = DMA_IP_CH_SET_DESTINATION_ADDRESS;
    Lpi2c_Ip_aDmaChannelTransferListSend[4u].Param = DMA_IP_CH_SET_DESTINATION_SIGNED_OFFSET;
    Lpi2c_Ip_aDmaChannelTransferListSend[5u].Param = DMA_IP_CH_SET_DESTINATION_TRANSFER_SIZE;
    /* Minor/Major Loop parameters */
    Lpi2c_Ip_aDmaChannelTransferListSend[6u].Param = DMA_IP_CH_SET_MINORLOOP_SIZE;
    Lpi2c_Ip_aDmaChannelTransferListSend[7u].Param = DMA_IP_CH_SET_MAJORLOOP_COUNT;
    /* Disable Hw auto request and enable interrupts */
    Lpi2c_Ip_aDmaChannelTransferListSend[8u].Param = DMA_IP_CH_SET_CONTROL_DIS_AUTO_REQUEST;
    Lpi2c_Ip_aDmaChannelTransferListSend[9u].Param = DMA_IP_CH_SET_CONTROL_EN_MAJOR_INTERRUPT;

    /* Source  configuration values */
    Lpi2c_Ip_aDmaChannelTransferListSend[1u].Value = 1U;
    Lpi2c_Ip_aDmaChannelTransferListSend[2u].Value = DMA_IP_TRANSFER_SIZE_1_BYTE;
    /* Destination configuration values */
    Lpi2c_Ip_aDmaChannelTransferListSend[4u].Value = 0U;
    Lpi2c_Ip_aDmaChannelTransferListSend[5u].Value = DMA_IP_TRANSFER_SIZE_1_BYTE;
    /* Minor/Major Loop values */
    Lpi2c_Ip_aDmaChannelTransferListSend[6u].Value = 1U;
    /* Disable Hw auto request and enable interrupts */
    Lpi2c_Ip_aDmaChannelTransferListSend[8u].Value = 1U;
    Lpi2c_Ip_aDmaChannelTransferListSend[9u].Value = 1U;

    /* Configure DMA channel for receive transfers*/
    /* Source  configuration parameters  */
    Lpi2c_Ip_aDmaChannelTransferListReceive[0u].Param = DMA_IP_CH_SET_SOURCE_ADDRESS;
    Lpi2c_Ip_aDmaChannelTransferListReceive[1u].Param = DMA_IP_CH_SET_SOURCE_SIGNED_OFFSET;
    Lpi2c_Ip_aDmaChannelTransferListReceive[2u].Param = DMA_IP_CH_SET_SOURCE_TRANSFER_SIZE;
    /* Destination configuration parameters  */
    Lpi2c_Ip_aDmaChannelTransferListReceive[3u].Param = DMA_IP_CH_SET_DESTINATION_ADDRESS;
    Lpi2c_Ip_aDmaChannelTransferListReceive[4u].Param = DMA_IP_CH_SET_DESTINATION_SIGNED_OFFSET;
    Lpi2c_Ip_aDmaChannelTransferListReceive[5u].Param = DMA_IP_CH_SET_DESTINATION_TRANSFER_SIZE;
    /* Minor/Major Loop parameters */
    Lpi2c_Ip_aDmaChannelTransferListReceive[6u].Param = DMA_IP_CH_SET_MINORLOOP_SIZE;
    Lpi2c_Ip_aDmaChannelTransferListReceive[7u].Param = DMA_IP_CH_SET_MAJORLOOP_COUNT;
    /* Disable Hw auto request and enable interrupts */
    Lpi2c_Ip_aDmaChannelTransferListReceive[8u].Param = DMA_IP_CH_SET_CONTROL_DIS_AUTO_REQUEST;
    Lpi2c_Ip_aDmaChannelTransferListReceive[9u].Param = DMA_IP_CH_SET_CONTROL_EN_MAJOR_INTERRUPT;

    /* Source  configuration values */
    Lpi2c_Ip_aDmaChannelTransferListReceive[1u].Value = 0U;
    Lpi2c_Ip_aDmaChannelTransferListReceive[2u].Value = DMA_IP_TRANSFER_SIZE_1_BYTE;
    /* Destination configuration values */
    Lpi2c_Ip_aDmaChannelTransferListReceive[4u].Value = 1U;
    Lpi2c_Ip_aDmaChannelTransferListReceive[5u].Value = DMA_IP_TRANSFER_SIZE_1_BYTE;
    /* Minor/Major Loop values */
    Lpi2c_Ip_aDmaChannelTransferListReceive[6u].Value = 1U;
    /* Disable Hw auto request and enable interrupts */
    Lpi2c_Ip_aDmaChannelTransferListReceive[8u].Value = 1U;
    Lpi2c_Ip_aDmaChannelTransferListReceive[9u].Value = 1U;
}
#endif /* STD_ON == LPI2C_IP_DMA_FEATURE_AVAILABLE */
                                        ...
                                        const Lpi2c_Ip_MasterConfigType * ConfigPtr)
{
    ...
    BaseAddr = Lpi2c_Ip_pxBase[Instance];
    Lpi2c_Ip_pxMasterState[Instance] = ConfigPtr->MasterState;
    Lpi2c_Ip_MasterStateType * Master =  Lpi2c_Ip_pxMasterState[Instance];
                                       ...
                                       const Lpi2c_Ip_SlaveConfigType * ConfigPtr)
{
    ...
    BaseAddr = Lpi2c_Ip_pxBase[Instance];
    Lpi2c_Ip_pxSlaveState[Instance] = ConfigPtr->SlaveState;
