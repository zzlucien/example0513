...
#define SIUL2_PORT_IP_SW_MAJOR_VERSION_CFG_C                1
...
- pin_list:
  - {pin_num: J15, peripheral: LPI2C_0, signal: 'lpi2c_scl, scl', pin_signal: PTF20, direction: INPUT/OUTPUT}
  - {pin_num: K14, peripheral: LPI2C_0, signal: 'lpi2c_sda, sda', pin_signal: PTF21, direction: INPUT/OUTPUT}
